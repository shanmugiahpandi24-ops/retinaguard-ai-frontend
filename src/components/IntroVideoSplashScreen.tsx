...
export const IntroVideoSplashScreen: React.FC<IntroVideoSplashScreenProps> = ({
  ...
  return (
    <div
      className={`fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-[#071321] text-white transition-opacity duration-600 ease-out ${
    ...
    >
      ...
      {!videoError ? (
        ...
        /* High-Tech Animated Fallback (When video file is being replaced or not yet present) */
